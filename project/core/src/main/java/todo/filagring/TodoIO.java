...
public class TodoIO implements TodoInterface {
    ...
    public void save(Listeklasse liste) throws IOException {
        PrintWriter writer = new PrintWriter("src.src.main.src/src.src.main.src.src.src.main.src.src.main/java/todo/filagring/todo.txt");
        String words = "";
    ...
    public TodoObjectLoader load() throws IOException {
        Scanner scanner = new Scanner(new File("src.src.main.src/src.src.main.src.src.src.main.src.src.main/java/todo/filagring/todo.txt"));
